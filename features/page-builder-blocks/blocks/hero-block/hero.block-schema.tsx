    ...
    defineField({
      ...
      of: [{
        ...
        fields: [
          ...
          defineField({ name: "useClerkSignIn", type: "boolean", title: "Use Clerk Sign-in" }),
          defineField({
            name: "href",
            type: "string",
            hidden: ({ parent }) => !!parent?.useClerkSignIn,
          }),
          defineField({
            name: "target",
            type: "boolean",
          ...
          defineField({
            ...
            title: "Clerk Mode",
            type: "string",
            options: { list: ["modal", "redirect"] },
            initialValue: "modal",
            hidden: ({ parent }) => !parent?.useClerkSignIn,
          }),
          defineField({
            name: "afterSignInUrl",
            title: "After Sign-in URL",
            type: "string",
