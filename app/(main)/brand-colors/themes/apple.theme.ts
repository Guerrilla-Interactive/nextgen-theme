...
export const APPLE_THEME: BrandDefinition = {
  ...
  brandColors: [
    {
      name: "Apple Blue",
      hex: "#007AFF", // System Blue
      variableName: "brand-blue-primary",
      shades: {
        "50": { hex: "#F0F8FF", variableName: "brand-blue-50" },
        "100": { hex: "#E1F2FF", variableName: "brand-blue-100" },
        "200": { hex: "#C2E5FF", variableName: "brand-blue-200" },
        "300": { hex: "#84CBFF", variableName: "brand-blue-300" },
        "400": { hex: "#4DB8FF", variableName: "brand-blue-400" },
        "500": { hex: "#007AFF", variableName: "brand-blue-500" },
        "600": { hex: "#0051D5", variableName: "brand-blue-600" },
        "700": { hex: "#004299", variableName: "brand-blue-700" },
        "800": { hex: "#002E66", variableName: "brand-blue-800" },
        "900": { hex: "#001A33", variableName: "brand-blue-900" },
      },
    },
    {
      name: "Apple Green",
      hex: "#32D74B", // Modern System Green (iOS 17)
      variableName: "brand-green-primary",
      shades: {
        "50": { hex: "#F0FDF4", variableName: "brand-green-50" },
        "100": { hex: "#E6FFEC", variableName: "brand-green-100" },
        "200": { hex: "#C7F9CC", variableName: "brand-green-200" },
        "300": { hex: "#86EFAC", variableName: "brand-green-300" },
        "400": { hex: "#4ADE80", variableName: "brand-green-400" },
        "500": { hex: "#32D74B", variableName: "brand-green-500" },
        "600": { hex: "#22C55E", variableName: "brand-green-600" },
        "700": { hex: "#16A34A", variableName: "brand-green-700" },
        "800": { hex: "#15803D", variableName: "brand-green-800" },
        "900": { hex: "#14532D", variableName: "brand-green-900" },
      },
    },
    {
      name: "Apple Gray",
      hex: "#000000", // True black for maximum readability
      variableName: "brand-gray-primary",
      shades: {
        "50": { hex: "#FFFFFF", variableName: "brand-gray-50" },
        "100": { hex: "#F9F9FB", variableName: "brand-gray-100" },
        "200": { hex: "#F2F2F7", variableName: "brand-gray-200" },
        "300": { hex: "#E5E5EA", variableName: "brand-gray-300" },
        "400": { hex: "#D1D1D6", variableName: "brand-gray-400" },
        "500": { hex: "#AEAEB2", variableName: "brand-gray-500" },
        "600": { hex: "#424242", variableName: "brand-gray-600" },
        "700": { hex: "#2E2E2E", variableName: "brand-gray-700" },
        "800": { hex: "#1A1A1A", variableName: "brand-gray-800" },
        "900": { hex: "#000000", variableName: "brand-gray-900" },
      },
    },
    {
      name: "Apple Red",
      hex: "#FF3B30", // System Red
      variableName: "brand-red-primary",
      shades: {
        "50": { hex: "#FEF2F2", variableName: "brand-red-50" },
        "100": { hex: "#FEE2E2", variableName: "brand-red-100" },
        "200": { hex: "#FECACA", variableName: "brand-red-200" },
        "300": { hex: "#FCA5A5", variableName: "brand-red-300" },
        "400": { hex: "#F87171", variableName: "brand-red-400" },
        "500": { hex: "#FF3B30", variableName: "brand-red-500" },
        "600": { hex: "#DC2626", variableName: "brand-red-600" },
        "700": { hex: "#B91C1C", variableName: "brand-red-700" },
        "800": { hex: "#991B1B", variableName: "brand-red-800" },
        "900": { hex: "#7F1D1D", variableName: "brand-red-900" },
      },
    },
    {
      name: "Apple Orange",
      hex: "#FF9500", // Modern System Orange
      variableName: "brand-orange-primary",
      shades: {
        "50": { hex: "#FFF7ED", variableName: "brand-orange-50" },
        "100": { hex: "#FFEDD5", variableName: "brand-orange-100" },
        "200": { hex: "#FED7AA", variableName: "brand-orange-200" },
        "300": { hex: "#FDBA74", variableName: "brand-orange-300" },
        "400": { hex: "#FB923C", variableName: "brand-orange-400" },
        "500": { hex: "#FF9500", variableName: "brand-orange-500" },
        "600": { hex: "#EA580C", variableName: "brand-orange-600" },
        "700": { hex: "#C2410C", variableName: "brand-orange-700" },
        "800": { hex: "#9A3412", variableName: "brand-orange-800" },
        "900": { hex: "#7C2D12", variableName: "brand-orange-900" },
      },
    },
    {
      name: "Apple Purple",
      hex: "#BF5AF2", // Modern System Purple (iOS 17)
      variableName: "brand-purple-primary",
      shades: {
        "50": { hex: "#FAF5FF", variableName: "brand-purple-50" },
        "100": { hex: "#F3E8FF", variableName: "brand-purple-100" },
        "200": { hex: "#E9D5FF", variableName: "brand-purple-200" },
        "300": { hex: "#D8B4FE", variableName: "brand-purple-300" },
        "400": { hex: "#C084FC", variableName: "brand-purple-400" },
        "500": { hex: "#BF5AF2", variableName: "brand-purple-500" },
        "600": { hex: "#9333EA", variableName: "brand-purple-600" },
        "700": { hex: "#7C3AED", variableName: "brand-purple-700" },
        "800": { hex: "#6B21A8", variableName: "brand-purple-800" },
        "900": { hex: "#581C87", variableName: "brand-purple-900" },
      },
    },
  ],
  brand: {
  ...
  elevation: {
    ...
    shadowBrandMd: "0 4px 16px rgba(0, 122, 255, 0.2)",
  ...
  spacing: {
    ...
    paddingButton: "0.625rem var(--space-lg)",
  ...
  borderStyles: {
    defaultColor: "var(--apple-brand-gray-400)",
    subtleColor: "var(--apple-brand-gray-300)",
    strongColor: "var(--apple-brand-gray-600)", // Much darker borders
    defaultWidth: "1px",
    thinWidth: "0.5px",
    thickWidth: "2px",
    defaultStyle: "solid",
  ...
  componentStyles: {
    nav: {
      ...
      borderColor: "rgba(209, 209, 214, 0.3)",
