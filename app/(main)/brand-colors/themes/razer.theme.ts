...
export const RAZER_THEME: BrandDefinition = {
    ...
    brandColors: [
      {
        ...
        shades: {
          "50": { color: "#E6FFE6", variableName: "brand-green-50" },
          "100": { color: "#CCFFCC", variableName: "brand-green-100" },
          "200": { color: "#99FF99", variableName: "brand-green-200" },
          "300": { color: "#66FF66", variableName: "brand-green-300" },
          "400": { color: "#33FF33", variableName: "brand-green-400" },
          "500": { color: "#00FF00", variableName: "brand-green-500" },
          "600": { color: "#00CC00", variableName: "brand-green-600" },
          "700": { color: "#009900", variableName: "brand-green-700" },
          "800": { color: "#006600", variableName: "brand-green-800" },
          "900": { color: "#003300", variableName: "brand-green-900" },
        }
      },
      {
        name: "Razer Dark",
        ...
        shades: {
          "50": { color: "#2C2C2C", variableName: "brand-dark-50" },
          "100": { color: "#252525", variableName: "brand-dark-100" },
          "200": { color: "#1E1E1E", variableName: "brand-dark-200" },
          "300": { color: "#1B1B1B", variableName: "brand-dark-300" },
          "400": { color: "#1A1A1A", variableName: "brand-dark-400" },
          "500": { color: "#1A1A1A", variableName: "brand-dark-500" },
          "600": { color: "#171717", variableName: "brand-dark-600" },
          "700": { color: "#131313", variableName: "brand-dark-700" },
          "800": { color: "#101010", variableName: "brand-dark-800" },
          "900": { color: "#0A0A0A", variableName: "brand-dark-900" },
        }
      },
      {
        name: "Razer Gray",
        ...
        shades: {
          "50": { color: "#F5F5F5", variableName: "brand-gray-50" },
          "100": { color: "#EAEAEA", variableName: "brand-gray-100" },
          "200": { color: "#D3D3D3", variableName: "brand-gray-200" },
          "300": { color: "#B0B0B0", variableName: "brand-gray-300" },
          "400": { color: "#A0A0A0", variableName: "brand-gray-400" },
          "500": { color: "#808080", variableName: "brand-gray-500" },
          "600": { color: "#777777", variableName: "brand-gray-600" },
          "700": { color: "#555555", variableName: "brand-gray-700" },
          "800": { color: "#3A3A3A", variableName: "brand-gray-800" },
          "900": { color: "#1C1C1C", variableName: "brand-gray-900" },
        }
      }
    ],
    brand: {
    ...
    componentStyles: {
      ...
      card: {
        ...
        borderColor: "var(--border-color-subtle, #666666)", 
        borderWidth: "1px",
