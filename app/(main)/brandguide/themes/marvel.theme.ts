    ...
    fonts: [
      {
        ...
        description: "Clean, readable sans-serif for body text and UI elements.",
      ...
      },
      {
        name: "Oswald",
        distributor: "Google Fonts",
        description: "Bold, heroic display font perfect for Marvel's dramatic aesthetic.",
        family: "'Oswald', 'Bebas Neue', 'Anton', sans-serif",
      ...
      },
      {
        name: "JetBrains Mono",
        distributor: "Google Fonts",
        description: "Modern monospaced font for technical content.",
