...
export const nintendoBrand: Brand = {
  ...
  fonts: [
    ...
    },
    {
      name: "Fredoka One",
      distributor: "Google Fonts",
      description: "Playful display typeface for major headings.",
      family: "'Fredoka One', cursive",
      roles: ["h1", "h2", "hero-title", "nav-title", "display"],
      weights: { regular: 400},
    },
    {
      name: "Roboto Mono",
      distributor: "Google Fonts",
      description: "Monospaced font for code snippets or tabular data.",
    ...
    },
    {
      name: "Open Sans",
      distributor: "Google Fonts",
      description: "Clean sans-serif for subheadings.",
