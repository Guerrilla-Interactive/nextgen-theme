  ...
  fonts: [
    {
      ...
      description: "Clean, readable sans-serif perfect for Scandinavian design aesthetic.",
      family: "'Source Sans 3', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
      roles: ["body", "default", "sans", "p", "a", "li", "button-label", "form-input", "h3", "h4", "h5", "h6"],
      weights: { light: 300, regular: 400, medium: 500, semibold: 600, bold: 700 },
    },
    {
      name: "Barlow",
      distributor: "Google Fonts", 
      description: "Modern, functional display font perfect for Nordic minimalism and headings.",
      family: "'Barlow', 'Source Sans 3', system-ui, sans-serif",
      roles: ["display", "h1", "h2", "hero-title"],
      weights: { medium: 500, semibold: 600, bold: 700, extrabold: 800, black: 900 },
    },
    {
      name: "Source Code Pro", 
      distributor: "Google Fonts",
      description: "Clean monospaced font that complements Source Sans 3 perfectly.",
      family: "'Source Code Pro', 'SF Mono', Monaco, Inconsolata, 'Roboto Mono', Consolas, 'Courier New', monospace",
      roles: ["code", "mono"],
