  ...
  fonts: [
    {
      ...
      description: "Main sans-serif font for body and UI.",
    ...
    },
    {
      name: "Syne",
      distributor: "Google Fonts",
      description: "Impactful display typeface for headings.",
      family: "var(--font-syne), 'Titillium Web', sans-serif",
      roles: ["h1", "h2", "h3", "hero-title", "nav-title", "display"],
      weights: { regular: 400, medium: 500, semibold: 600, bold: 700, extrabold: 800 },
    },
    {
      name: "Geist Sans",
      distributor: "Vercel",
      description: "Modern sans-serif for UI text. Clean and legible.",
      family: "var(--font-geist-sans), Geist, sans-serif",
      roles: ["h4", "h5", "h6", "p", "a", "li", "button-label", "form-input"],
      weights: { light: 300, regular: 400, medium: 500, semibold: 600, bold: 700 },
    },
    {
      name: "PT Serif",
      distributor: "Google Fonts",
      description: "Serif font, for specific contrasting text if needed.",
      family: "'PT Serif', serif",
      roles: ["serif-body", "serif"],
      weights: { regular: 400, bold: 700 },
    },
  ],
