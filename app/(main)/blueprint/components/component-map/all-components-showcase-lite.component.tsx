...
import { Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbList, BreadcrumbPage, BreadcrumbSeparator } from '@/features/unorganized-components/ui/breadcrumb';
...
import { ChartContainer, ChartTooltipContent } from '@/features/unorganized-components/ui/chart';
...
const generateSimpleTokenTooltipContent = (doc: ComponentDocumentation) => {
...
export const AllComponentsShowcaseLite = () => {
  return (
          ...
          <CardHeader className="relative">
            ...
            <Tooltip>
              ...
              <TooltipContent className="max-w-xs p-3">
                {generateSimpleTokenTooltipContent(doc)}
              </TooltipContent>
            </Tooltip>
          </CardHeader>
